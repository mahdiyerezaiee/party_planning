...
/**
 * A button component that navigates the user to the previous page when clicked.
 *
 * @constructor
 */
const ButtonBack: React.FC = () => {
    ...
    /** Click Handler to Dispatch an action to update the page number to the previous page **/
    const clickHandler = () => {
